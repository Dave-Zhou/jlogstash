 ...
 */
package com.tansun.jlogstash.factory;

import com.tansun.jlogstash.annotation.plugin.AnnotationInterface;
...
public abstract class InstanceFactory {
                ...
                if (an != null) {
                  ...
                  if (pack != null) {
                    if (annotationPackage.equals(pack.getName())) {
                      logger.debug("field: {} annotation:{} check", name,
  ...
  private static void checkAnnotation(Field field, Annotation an, Object obj) throws Exception {
    String className =
        SystemProperty.getSystemProperty("annotationPlugin") + "." + an.annotationType()
            .getSimpleName() + "Plugin";
    Class<?> cla = null;
    try {
